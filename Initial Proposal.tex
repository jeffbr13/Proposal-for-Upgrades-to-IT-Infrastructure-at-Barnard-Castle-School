...
Whatever amount of this proposal is considered, the most important message we
want you to take from this is thus: a dialogue needs be set up between the users
and administrators, so that those responsible know what the people want,
and the things which will actually help them, while the users know that real
progress is being made on their behalf, and their needs are being addressed.
This proposal, and the accompanying petition, is the most
concrete sign yet, that students (and staff?) in Barnard Castle School are
